...
public class DoltModHowLootTables extends LootTableProvider {
    ...
    public static class DoltModHowBlockLoot extends BlockLootSubProvider {
        ...
        BlockState blockstate = (item instanceof BlockItem ?
                (this.getEmptyPot().fullPots.getOrDefault
                        (ForgeRegistries.BLOCKS.getKey(item.getBlock()), ForgeRegistries.BLOCKS.getDelegateOrThrow(Blocks.AIR)
                        ).get() : Blocks.AIR).defaultBlockState();
